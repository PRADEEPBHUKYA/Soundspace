      ...
      SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(mainAxisAlignment:MainAxisAlignment.spaceBetween, children:[
            ...
            TextButton(
              onPressed:(){ HapticFeedback.lightImpact(); p.resetEQ(); },
          ...
          // Presets
          Text('PRESETS',style:const TextStyle(color:SS.t3,fontSize:10,fontWeight:FontWeight.w700,letterSpacing:2)),
...
class _TrackP extends CustomPainter {
  ...
  @override void paint(Canvas c, Size s) {
    ...
    final ap=Paint()..color=color.withOpacity(drag?1:.75)
    ...
    c.drawCircle(Offset(cx,ty),drag?9:7,
      Paint()..color=color.withOpacity(drag?.5:.25)..maskFilter=const MaskFilter.blur(BlurStyle.normal,8));
    c.drawCircle(Offset(cx,ty),drag?9:7,
